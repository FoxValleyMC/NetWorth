...
import NetWorth.Overrides.NetWorthPlayer;
...
public class NetWorthCommand extends PluginCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        if (sender instanceof NetWorthPlayer) {

            NetWorthPlayer player = (NetWorthPlayer) sender;
    ...
    void sendHelp(NetWorthPlayer player) {
    ...
    void setMoney(NetWorthPlayer player, String receiver, int amount) {
        if (player.hasPermission("networth.admin")) {
            NetWorthPlayer var1 = (NetWorthPlayer) plugin.getServer().getPlayer(receiver);
            if (var1 != null) {
                ...
                try {
                    ...
                    if (aliasMap != null) {
                        ...
                        if (objectMap != null) {
                            ...
                            NetWorthPlayer var2 = (NetWorthPlayer) plugin.getServer().getPlayer(name);
                            if (var2 != null) {
    ...
    void sendMoney(NetWorthPlayer player, String receiver, int amount) {
        NetWorthPlayer var1 = (NetWorthPlayer) plugin.getServer().getPlayer(receiver);
    ...
    void getBalance(NetWorthPlayer player, String query) {
        NetWorthPlayer var1 = (NetWorthPlayer) plugin.getServer().getPlayer(query);
        if (var1 != null) {
            if (player.getName().equals(var1.getName())) {
